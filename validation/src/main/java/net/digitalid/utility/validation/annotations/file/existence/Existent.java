...
/**
 * This annotation indicates that the annotated {@link File file} {@link File#exists() exists}.
 * 
 * @see NonExistent
 */
@Documented
...
@ValueValidator(Existent.Validator.class)
public @interface Existent {
    ...
    public static class Validator extends FileValidator {
        ...
        public @Nonnull Contract generateContract(@Nonnull Element element, @Nonnull AnnotationMirror annotationMirror, @NonCaptured @Modified @Nonnull TypeImporter typeImporter) {
            return Contract.with("# == null || #.exists()", "The # $ has to exist.", element);
        }
