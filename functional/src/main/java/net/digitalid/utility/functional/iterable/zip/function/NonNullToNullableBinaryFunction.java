 ...
 */
@Stateless
public abstract class NonNullToNullableBinaryFunction<I, O> implements ToNullableBinaryFunction<I, O> {
    ...
    @Pure
    @Override
    public abstract @Nullable O apply(@Nonnull I element1, @Nonnull I element2);
