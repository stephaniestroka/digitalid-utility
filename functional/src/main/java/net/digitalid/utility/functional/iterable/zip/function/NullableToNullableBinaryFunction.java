 ...
 */
@Stateless
public abstract class NullableToNullableBinaryFunction<I, O> implements ToNullableBinaryFunction<I, O> {
    ...
    @Pure
    @Override
    public abstract @Nullable O apply(@Nullable I element1, @Nullable I element2);
