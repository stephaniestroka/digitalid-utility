...
public class Evaluate {
     ...
     */
    @Pure
    public static <I> void ifNotNull(@Nullable I input, @Nonnull Consumer<? super I> consumer) {
     ...
     */
    @Pure
    public static <I> boolean ifNotNull(@Nullable I input, @Nonnull Predicate<? super I> predicate, boolean defaultOutput) {
     ...
     */
    @Pure
    public static <I> boolean ifNotNull(@Nullable I input, @Nonnull Predicate<? super I> predicate) {
     ...
     */
    @Pure
    public static <I, O> O ifNotNull(@Nullable I input, @Nonnull UnaryFunction<? super I, ? extends O> function, O defaultOutput) {
     ...
     */
    @Pure
    public static <I, O> O ifNotNull(@Nullable I input, @Nonnull UnaryFunction<? super I, ? extends O> function) {
     ...
     */
    @Pure
    public static <I0, I1, O> O ifFirstNotNull(@Nullable I0 input0, I1 input1, @Nonnull BinaryFunction<? super I0, ? super I1, ? extends O> function, O defaultOutput) {
     ...
     */
    @Pure
    public static <I0, I1, O> O ifFirstNotNull(@Nullable I0 input0, I1 input1, @Nonnull BinaryFunction<? super I0, ? super I1, ? extends O> function) {
     ...
     */
    @Pure
    public static <I0, I1, O> O ifBothNotNull(@Nullable I0 input0, @Nullable I1 input1, @Nonnull BinaryFunction<? super I0, ? super I1, ? extends O> function, O defaultOutput) {
     ...
     */
    @Pure
    public static <I0, I1, O> O ifBothNotNull(@Nullable I0 input0, @Nullable I1 input1, @Nonnull BinaryFunction<? super I0, ? super I1, ? extends O> function) {
