 ...
 *
 */
public class ListConverter<T extends Collection<?>> implements NodeConverter<T> {
    ...
    ListConverter(@Nonnull LeafConverter<?> converter) {
        this.converter = converter;
    }
    
    public static @Nonnull <T extends Collection<?>> ListConverter<T> of(@Nonnull LeafConverter<?> converter) {
