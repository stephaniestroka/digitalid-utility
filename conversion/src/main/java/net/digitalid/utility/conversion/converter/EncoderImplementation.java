 ...
 */
public abstract class EncoderImplementation<EXCEPTION extends ExternalException> implements Encoder<EXCEPTION> {
    
    /**
     * Collects a boolean value and processes it for conversion.
     */
    @Impure
    public abstract Integer setBoolean(boolean value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setInteger08(byte value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setInteger16(short value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setInteger32(int value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setInteger64(long value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setInteger(@Nonnull BigInteger value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setDecimal32(float value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setDecimal64(double value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setString01(char value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setString64(@Nonnull String value) throws EXCEPTION;
    
    @Impure
    @Override
    public Integer setNullableString64(@Nullable String value) throws EXCEPTION {
     ...
     */
    @Impure
    public abstract Integer setString(@Nonnull String value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setBinary128(@Nonnull @Size(16) byte[] value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setBinary256(@Nonnull @Size(32) byte[] value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setBinary(@Nonnull byte[] value) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract Integer setBinaryStream(@Nonnull InputStream stream, int length) throws EXCEPTION;
    
    @Impure
    @Override
    public Integer setNullableBinaryStream(@Nullable InputStream value, int length) throws EXCEPTION {
     ...
     */
    @Impure
    public abstract <T> Integer setList(@Nonnull List<@Nullable T> list, @Nonnull FailableUnaryFunction<@Nullable T, Integer, EXCEPTION> entityCollector) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract <T> Integer setArray(@Nonnull @NullableElements T[] value, @Nonnull FailableUnaryFunction<@Nullable T, Integer, EXCEPTION> entityCollector) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract <T> Integer setSet(@Nonnull Set<@Nullable T> value, @Nonnull FailableUnaryFunction<@Nullable T, Integer, EXCEPTION> entityCollector) throws EXCEPTION;
     ...
     */
    @Impure
    public abstract <K, V> Integer setMap(@Nonnull Map<@Nullable K, @Nullable V> value, @Nonnull FailableUnaryFunction<@Nullable K, Integer, EXCEPTION> keyCollector, @Nonnull FailableUnaryFunction<@Nullable V, Integer, EXCEPTION> encoder) throws EXCEPTION;
    
    @Impure
    @Override
    public <K, V> Integer setNullableMap(@Nullable Map<@Nullable K, @Nullable V> value, @Nonnull FailableUnaryFunction<@Nullable K, Integer, EXCEPTION> keyCollector, @Nonnull FailableUnaryFunction<@Nullable V, Integer, EXCEPTION> encoder) throws EXCEPTION {
        return value == null ? setNull(CustomType.MAP) : setMap(value, keyCollector, encoder);
    }
