...
import static net.digitalid.utility.conversion.model.CustomType.STRING;
...
public class StringConverter implements Converter<String, Void> {
    ...
    private static final @Nonnull ImmutableList<@Nonnull CustomField> fields = ImmutableList.withElements(CustomField.with(STRING, "string", ImmutableList.withElements(CustomAnnotation.with(Nonnull.class))));
    ...
    @Pure
    @Override
    public @Capturable <EXCEPTION extends ConnectionException> @Nonnull String recover(@NonCaptured @Modified @Nonnull Decoder<EXCEPTION> decoder, Void provided) throws EXCEPTION {
