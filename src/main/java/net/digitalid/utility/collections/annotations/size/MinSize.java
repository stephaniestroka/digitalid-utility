...
public @interface MinSize {
    ...
    /**
     * Returns the minimum number of elements that the annotated collection or array contains.
     * 
     * @return the minimum number of elements that the annotated collection or array contains.
     */
    int value();
