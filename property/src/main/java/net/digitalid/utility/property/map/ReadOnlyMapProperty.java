...
public interface ReadOnlyMapProperty<KEY, VALUE, READONLY_MAP extends ReadOnlyMap<@Nonnull @Valid("key") KEY, @Nonnull @Valid VALUE>, EXCEPTION extends Exception, OBSERVER extends MapObserver<KEY, VALUE, READONLY_MAP, EXCEPTION, OBSERVER, PROPERTY>, PROPERTY extends ReadOnlyMapProperty<KEY, VALUE, READONLY_MAP, EXCEPTION, OBSERVER, PROPERTY>> extends Property<OBSERVER>, Valid.Key<KEY>, Valid.Value<VALUE> {
     ...
     */
    @Pure
    public @Nonnull @NonFrozen READONLY_MAP get() throws EXCEPTION;
    
    /**
     * Returns the value for the given key of this property.
     */
    @Pure
    public @NonCapturable @Nullable @Valid VALUE get(@NonCaptured @Unmodified @Nonnull @Valid("key") KEY key) throws EXCEPTION;
